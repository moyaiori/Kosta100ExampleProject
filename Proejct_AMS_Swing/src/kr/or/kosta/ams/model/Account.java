...
//		String temp = formatter.format("%,d",restMoney).toString();
//		return Long.valueOf(temp);
	...
	public long withdraw(long money) throws Exception{
		...
		if (money < 10000) {
			throw new AccountExcetion("출금은 만원이상 부터 가능합니다.", 100);
		}else if(money > restMoney){
			throw new AccountExcetion("예금보다 많은금액을 출금할 수 없습니다.", 200);
		}
	...
	public static void main(String[] args){
		Account owner = new Account("1111-2222","이광용",1234,15000);
		try {
			owner.withdraw(9000);
//			owner.withdraw(-9000);
		} catch (Exception e) {
