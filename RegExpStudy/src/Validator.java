...
public class Validator {
	...
	public static boolean validEmail(String email) {
		return email.matches("^[a-zA-Z0-9]+@[a-zA-Z0-9]+(\\.[\\w]+)+$");
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(Validator.validMobileNumber("019-1234-1234"));
		System.out.println(Validator.validSSN("680313-1234568"));
		System.out.println(Validator.validIP("192.168.34.56"));
