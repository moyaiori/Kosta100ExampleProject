...
public class RaceUI extends JFrame {
	...
	public void readyRace(){
		...
		runners[0] = new Runner(Stadium.startLine, 320, "지성", "/images/jjangu0.gif");
		runners[1] = new Runner(Stadium.startLine, 350, "찬호", "/images/jjangu1.gif");
		runners[2] = new Runner(Stadium.startLine, 410, "승엽", "/images/jjangu2.gif");
		runners[3] = new Runner(Stadium.startLine, 470, "기정", "/images/jjangu3.gif");
